...
function id_check_win_open(){
	window.open("${path}/member_servlet/id_check_win.do", "네이버새창","width=640, height=480, toolbar=no, menubar=no, scrollbars=no, resizable=yes");
}
...
function join(){
	if(confirm('가입하시겠습니까?')){
		DirForm.method="post";
		DirForm.action="${path}/member_servlet/chugaProc.do";
		DirForm.submit();
	}
}
</script>	
