...
<input type="hidden" name="no" value="${dto.no }">
	...
	<table border="1" align="center" width="80%">
		...
		<tr>
			<td>성별</td>
			<td><input type="radio" name="gender" value="F" <c:if test="${dto.gender.equals('F')}">checked</c:if>>여자
			
				<input type="radio" name="gender" value="M" <c:if test="${dto.gender.equals('M')}">checked</c:if>>남자
			<%--	
		...
		<tr>
			...
			<button type="button" onclick="join();">수정하기</button></td>
		</tr>
	</table>
</form>
