...
public class SurveyController extends HttpServlet {
	...
	//페이징 처리소스  
	int pageSize=50; //레코드(튜플)을 10개 보여주는것
	...
	ArrayList<SurveyDTO> list =dao.getList(startRecord,lastRecord,list_gubun,search_option,search_data,search_date_s,search_date_e,search_date_check);
