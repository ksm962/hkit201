...
public class ProductController extends HttpServlet {
	...
	protected void doProc(HttpServletRequest request, HttpServletResponse response)
		...
		if (url.indexOf("index.do") != -1) {
			...
			/*
			 * temp=""; for (int i=0; i<array.length; i++) {
			 * 
			 * //System.out.println("array["+i+"]"+array[i]); String imsi= array[i];
			 * if(imsi==null) { imsi="-"; } temp+=","+imsi; } System.out.println(temp);
			 * temp=temp.substring(1); System.out.println(temp);
			 */
