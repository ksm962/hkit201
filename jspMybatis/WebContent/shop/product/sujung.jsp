<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <%@ include file="../../include/inc_header.jsp" %>
		...
		<tr>
			...
			<td><input type="text" name="price" id="price" value="${dto.price }">
	...
	<tr>
			...
			<td><textarea name="description" id="description"  style="width:300px; height:100px;" wrap="hard">${dto.description }</textarea>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<img src="${path }/attach/image/${temp3 }" alt="${dto.name }" title="${dto.name }" style="width:100px; height:100px;">
				</c:if>
			</td>
		</tr>
