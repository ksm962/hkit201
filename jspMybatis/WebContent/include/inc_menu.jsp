	...
	<table border="0" align="center">
		<tr>
			<td colspan="15" align="right" style="padding:5px 20px 10px;">
				...
				&nbsp;&nbsp;
				<a href="${path }/member_servlet/index.do?menuMove=chuga">회원가입</a>
				
     	</c:if>
     	
    
            <c:if test="${sessionScope.cookNo != null && sessionScope.cookNo !=0}">
			<a href="${path }/member_servlet/index.do?menuMove=modfiy">[회원정보 수정]</a>
			<a href="${path }/member_servlet/index.do?menuMove=d">[회원 탈퇴]</a>
		...
		<tr>
			...
			<a href="${path}/member_servlet/index.do">회원관리</a></td>
